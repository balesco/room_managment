                            ...
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-lg-3">
                                        ...
                                        <div id="external-events" class="m-t-20">
                                            ...
                                            <div class="external-event bg-danger" data-class="bg-danger">
                                                <i class="mdi mdi-checkbox-blank-circle mr-2 vertical-middle"></i>Create New
                                                theme
                                            </div>
                                        </div>
                                    ...
                                    <div class="col-lg-9">
                                        ...
                                        <input type="hidden" id="room_datas" name="data"
                                            value="{{ json_encode($room->reservations) }}">
                                        @csrf
                                        <div id="calendar"></div>
                                    </div> <!-- end col -->
                                ...
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body p-4">
                                        ...
                                        <div class="text-right">
                                            <button type="button" class="btn btn-light " data-dismiss="modal">Close</button>
                                            <button type="button" class="btn btn-primary ml-1   save-category"
