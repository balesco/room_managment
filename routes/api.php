...
use App\Http\Controllers\Api\RoomReservationsController;
...
Route::name('api.')
    ...
    ->group(function () {
        ...
        // Room Reservations
        Route::get('/rooms/{room}/reservations', [
            RoomReservationsController::class,
            'index',
        ])->name('rooms.reservations.index');
        Route::post('/rooms/{room}/reservations', [
            RoomReservationsController::class,
            'store',
        ])->name('rooms.reservations.store');
    });
