...
;(function(root) {
	...
	var TABLE = 'https://coderthemes.com/hyper/modern/ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/';
...
!(__WEBPACK_AMD_DEFINE_RESULT__ = function (require) {
    ...
    return function module() {
        ...
        function cleanData(_ref11) {
            ...
            if (!dataByTopic && !data) {
                throw new Error('https://coderthemes.com/hyper/modern/Data needs to have a dataByTopic or data property. See more in http://eventbrite.github.io/britecharts/global.html#LineChartData__anchor');
            }
